...
class LocationTest(unittest.TestCase):
  def setUp(self):
    ...
    self.geodetic_two = (37.4211366, -122.0936967, -10)
    self.ecef_two = (-2694174.993, -4297213.279, 3854317.404)
    self.geodetic_three = (31.230441, 121.467685, 4.5)
...
class CoordinateConversionTest(unittest.TestCase):
  ...
  def test_geodetic_to_cartesian_mountainview_negative_altitude(self):
    geodetic_mountainview_negative_altitude = (37.4211366, -122.0936967, -10)
